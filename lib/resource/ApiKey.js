 ...
 * @description
 *
 * Encapsulates an Api Key resource of an {@link Account}. These keys can be
 * used to authenticate requests to your web framework.
 *
 * The properties of this resource are documented in the REST API Reference, see
 * [Account API Keys](https://docs.stormpath.com/rest/product-guide/latest/reference.html?#account-api-keys).
 *
 ...
 *
 * This class should not be manually constructed, instances should be obtained
 * from  {@link Application#getApiKey Application.getApiKey()} or
