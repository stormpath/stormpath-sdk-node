 ...
 *
 * @param {Object} Resource reference. This should be a object literal
...
/**
 * Invalidates the cache of this resource.
 *
 * @param {Function} callback
 * The function to call when the cache invalidation operation is complete. Will be called
 * with the parameter (err).
 */
