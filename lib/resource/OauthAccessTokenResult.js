...
OauthAccessTokenResult.prototype.getToken = function getToken() {
  ...
  if(typeof self.applicationHref!=='string'){
    throw new ApiAuthRequestError('getToken() called before applicationHref was set');
  }
  ...
  return self._token = jwt.encode(_jwt,self.dataStore.requestExecutor.options.apiKey.secret,'HS256');
};
