 ...
 *
 * Typically you do not need to manually construct a CollectionResource. Rather,
...
* @description
*
* Visit each resouce in the collection.
*
...
* `next(err)`, the interation will stop and the `doneCallback` will be called
* with the value.
*
...
* @example
*
* application.getAccounts({ email: 'mydomain.com' }, function(err, collection){
