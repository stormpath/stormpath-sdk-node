...
Factor.prototype.getMostRecentChallenge = function getMostRecentChallenge(/* [options], callback */) {
  ...
  // Always loads an updated version of self, as changes might have happened without
  // this object being updated.
  this.dataStore.getResource(this.href, {}, Factor, function(err, factor) {
    if (factor.mostRecentChallenge && factor.mostRecentChallenge.href) {
      return factor.dataStore.getResource(factor.mostRecentChallenge.href, args.options, require('./Challenge'), args.callback);
    }
