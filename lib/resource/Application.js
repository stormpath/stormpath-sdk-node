...
Application.prototype.setDefaultAccountStore = function setDefaultAccountStore(store, callback) {
  var self = this;
  var mapping = require('./ResourceFactory').instantiate(AccountStoreMapping, { isDefaultAccountStore: true}, null, this.dataStore);
  mapping.setAccountStore(store);
  mapping.setApplication(self);
  return this.dataStore.createResource('/accountStoreMappings', null, mapping, AccountStoreMapping, function(){
    self.defaultAccountStoreMapping = { href: store.href};
    self.save(callback);
  });
};
...
Application.prototype.setDefaultGroupStore = function setDefaultGroupStore(store, callback) {
  var self = this;
  var mapping = require('./ResourceFactory').instantiate(AccountStoreMapping, { isDefaultGroupStore: true}, null, this.dataStore);
  mapping.setAccountStore(store);
  mapping.setApplication(self);
  return self.dataStore.createResource('/accountStoreMappings', null, mapping, AccountStoreMapping, function(){
    self.defaultGroupStoreMapping = { href: store.href };
    self.save(callback);
  });
};

Application.prototype.createAccountStoreMapping = function createAccountStoreMapping(accountStoreMapping, callback){
  var mapping = require('./ResourceFactory').instantiate(AccountStoreMapping, accountStoreMapping, null, this.dataStore);
...
Application.prototype.addAccountStore = function addAccountStore(store, callback){
  var mapping = require('./ResourceFactory').instantiate(AccountStoreMapping, {}, null, this.dataStore);
  mapping.setAccountStore(store);
  mapping.setApplication(this);
  return this.dataStore.createResource('/accountStoreMappings', null, mapping, AccountStoreMapping, callback);
};
