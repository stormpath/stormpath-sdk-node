 ...
 * @description
 *
 * Encapsulates a Application resource. For full documentation of this resource,
 * please see
 ...
 *
 * @param {GetResourceOptions} [getResourceOptions]
 * Query options for the request, e.g. to expand properties on the {@link
 * Directory}.
 *
 * @param {Function} callback
 * The function to call when the operation is complete. Will be called
 ...
 * a {@link Directory} or {@link Group}. This is the location that new accounts
 * are placed in, when using {@link Application#createAccount
