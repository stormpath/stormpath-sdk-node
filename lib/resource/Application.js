 ...
 * The password reset token that was created by {@link Application#sendPasswordResetEmail Application.sendPasswordResetEmail()}
 *
 * @param {String} newPassword The new password that the user desires.
 *
 * @param  {Function} callback
 * Callback function, will be called with (err).
 *
 ...
 *
 * * Prompt the user to authenticate with
 *   the provider, via your provider application (e.g. Facebook application consent screen, Google+ login)
