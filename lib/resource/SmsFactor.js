 ...
 * Factor creation options. Currently, no optional parameters are supported.
 *
...
SmsFactor.prototype.getPhone = function getPhone(/* callback */) {
  ...
  return this.dataStore.getResource(this.phone.href, null, require('./Phone'), args.callback);
};
