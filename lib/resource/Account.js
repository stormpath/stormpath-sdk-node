 ...
 *
 * The raw JSON data from the account resource, as retrieved from the API
 */
 ...
 * Options for querying the collection (limit, offset, etc).
 *
 * @param {Function} callback
 * The function to call when then the operation is complete.  Will be called
 * with the parameters (err, {@link CollectionResource}).
 */
