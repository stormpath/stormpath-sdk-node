...
Account.prototype.createApiKey = function createApiKey(options,callback) {
  ...
  return self.dataStore.createResource(self.apiKeys.href, new ApiKeyEncryptedOptions(opts), null, require('./ApiKey'), cb);
};
...
Account.prototype.getApiKeys = function getApiKeys(options,callback) {
  ...
  return self.dataStore.getResource(self.apiKeys.href, new ApiKeyEncryptedOptions(opts), require('./ApiKey'), cb);
};
