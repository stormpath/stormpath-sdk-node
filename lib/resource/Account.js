...
Account.prototype.transformOktaUser = function transformOktaUser () {
  ...
  extend(account, {
    href: account._links.self.href,
    fullName: userProfile.firstName + ' ' + userProfile.lastName,
    status: statusMap[account.status] ? statusMap[account.status] : 'UNKNOWN',
    createdAt: account.created,
    modifiedAt: account.lastUpdated,
    passwordModifiedAt: account.passwordChanged,
    emailVerificationStatus: emailVerificationStatusMap[account.status] ? emailVerificationStatusMap[account.status] : 'UNKNOWN',
    customData: {}
  });
