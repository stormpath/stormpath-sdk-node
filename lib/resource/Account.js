...
Account.prototype.createApiKey = function createApiKey(/* [options] , callback */) {
  ...
  return self.dataStore.createResource(self.apiKeys.href, new ApiKeyEncryptedOptions(), null, require('./ApiKey'), callback);
};
...
Account.prototype.getApiKeys = function getApiKeys(options,callback) {
  ...
  return self.dataStore.getResource(self.apiKeys.href, new ApiKeyEncryptedOptions(opts.id), require('./ApiKey'), cb);
};
