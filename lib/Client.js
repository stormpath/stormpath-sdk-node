 ...
 *
 * @property {String} [baseUrl] The base URL for the Stormpath API. Shared
 ...
 *
 * @property {Number} [cacheOptions.tti=300] (Seconds) The idle time of any
 * resource in the cache.  If it is not used within this time, it will be purged.
 *
 * @property {Object} [client]
 *
 * An existing Redis or Memcached client instance.  If you have specified the
 * `store` property, but not provided a client instance, then this library will
 * create a client instance for you.
 *
 * @property {String} [store] The type of cache store to use, can be `redis` or
 * `memcached`.  If not specified, and in-memory cache will be used for the
 ...
 *
 * - By passing them into the client constructor as the `apiKey` object.
 *
 ...
 *
 * Each of these strategies is shown by example below.  In addition to the API
 * Key requirements, you can configure the other properties seen in the table
 * below.
 *
 ...
 *
 * @example <caption>Assumes API keys are in environment variables, or stormpath.yaml:</caption>
 *
 ...
 *
 * @example <caption>stormpath.yml file format:</caption>
 * {@lang yaml}
 * client:
 *   apiKey:
 *     id: YOUR_API_KEY_ID
 ...
 *
 * @example <caption>Passing as options:</caption>
 *
 * var stormpath = require('stormpath');
 *
 * var client = new stormpath.Client({
