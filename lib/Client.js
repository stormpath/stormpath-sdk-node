...
Client.prototype.getCurrentTenant = function() {
  ...
  return args.callback(null, new Tenant({href: this.config.org}, self._dataStore));
...
Client.prototype.createUser = function() {
  ...
  this.dataStore.createResource('/users', args.user, args.options, require('./Account'), args.callback);
};
