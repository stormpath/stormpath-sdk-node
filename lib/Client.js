...
Client.prototype.getAccount = function() {
  ...
  return this.getResource('/users/' + args.id, args.options, require('./resource/Account'), args.callback);
};
...
Client.prototype.getApplication = function() {
  ...
  return this.getResource('/apps/' + args.id, args.options, require('./resource/Application'), args.callback);
};
