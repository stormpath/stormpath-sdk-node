 ...
 * access the response data and get access token for the account that was authenticated.
 *
 ...
 *
 */
OAuthClientCredentialsAuthenticator.prototype.authenticate = function authenticate(data, callback) {
